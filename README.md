...
**🔗 Frontend repo:** [github.com/shahadat-hossain99/trailnest-client](https://github.com/shahadat-hossain99/trailnest-client)
...
- Node.js 18+
- A MongoDB connection string — **the same database** your [TrailNest frontend](https://github.com/shahadat-hossain99/trailnest-client)'s BetterAuth instance uses, since this server reads its `session`/`user` collections directly.

### Installation

```bash
git clone https://github.com/shahadat-hossain99/trailnest-backend.git
